...
profile_prefix="accelprof -v -t app_analysis -d rocm"
...
python3 ${PY_DIR}/process_amd.py --log-file ${RAW_DATA_DIR}/${MODEL_NAME}_app_analysis_rocm.log &> ${RESULT_DIR}/out_amd.log
